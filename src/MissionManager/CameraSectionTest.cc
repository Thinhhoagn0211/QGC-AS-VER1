...
void CameraSectionTest::init(void)
{
    ...
    _validStartVideoItem = new SimpleMissionItem(_masterController,
                                                 ...
                                                 MissionItem(0,                             // sequence number
                                                             ...
                                                             std::numeric_limits<double>::quiet_NaN(), std::numeric_limits<double>::quiet_NaN(), std::numeric_limits<double>::quiet_NaN(), std::numeric_limits<double>::quiet_NaN(), std::numeric_limits<double>::quiet_NaN(),       // param 3-7 reserved
                                                             true,                          // autocontinue
                                                             false));                       // isCurrentItem
    ...
    _validTakePhotoItem = new SimpleMissionItem(_masterController,
                                                ...
                                                MissionItem(0,
                                                            ...
                                                            std::numeric_limits<double>::quiet_NaN(), std::numeric_limits<double>::quiet_NaN(), std::numeric_limits<double>::quiet_NaN(),                  // param 5-7 reserved
                                                            true,                           // autoContinue
                                                            false));                        // isCurrentItem
