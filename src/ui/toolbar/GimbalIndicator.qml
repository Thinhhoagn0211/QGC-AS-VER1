        ...
        GridLayout {
            ...
            QGCLabel {
                ...
                text: {
                    ...
                    if (activeGimbal && activeGimbal.retracted) {
                        return qsTr("Retracted");
                    }
                    
                    switch (gimbalController.gimbalCurrentMode) {
                        case 0:
                            return qsTr("Yaw Lock");
                        case 1:
                            return qsTr("Yaw follow");
                        case 2:
                            return qsTr("FPV Mode");
                        default:
            ...
            QGCLabel {
                id:             pitchLabel
                font.pointSize: ScreenTools.smallFontPointSize
                text:           gimbalController ? qsTr("P: ") + gimbalController.currentPitch.toFixed(1) : ""
            }
            QGCLabel {
                id:             panLabel
                font.pointSize: ScreenTools.smallFontPointSize
                text:           gimbalController ?
                                    (showAzimuth ?
                                        (qsTr("Az: ") + gimbalController.currentYaw.toFixed(1)) :
                                        (qsTr("Y: ") + gimbalController.currentRoll.toFixed(1))) :
                                    ""
            }
        }
    }
    ...
    Component {
        ...
        ColumnLayout {
            ...
            SettingsGroupLayout {
                ...
                QGCButton {
                    Layout.fillWidth: true
                    text: gimbalController.gimbalCurrentMode === 1 ? qsTr("Yaw Follow") : qsTr("Yaw Lock")
                    
                    visible: true
                    
                    onClicked: {
                        var nextMode = gimbalController.gimbalCurrentMode === 1 ? 0 : 1
                        
                        gimbalController.setCurrentGimbalMode(nextMode)
