...
Item {
    ...
    Component {
        ...
        ColumnLayout {
            ...
            SettingsGroupLayout {
                visible: _activeVehicle.autopilot.knownVehicleComponentAvailable(_activeVehicle.autopilot.KnownPowerVehicleComponent) &&
                ...
                LabelledButton {
                    ...
                    onClicked: {
                        mainWindow.showKnownVehicleComponentConfigPage(_activeVehicle.autopilot.KnownPowerVehicleComponent)
