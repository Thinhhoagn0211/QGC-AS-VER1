        ...
        Column {
            ...
            Rectangle {
                ...
                Column {
                    ...
                    Row {
                        spacing:    ScreenTools.defaultFontPixelWidth
                        visible:    mavlinkForwardingChecked.checked
                        QGCLabel {
                            width:              _labelWidth
                        ...
                        FactTextField {
                            ...
                            width:                  _valueWidth
                            visible:                QGroundControl.settingsManager.appSettings.forwardMavlinkHostName.visible
                            enabled:                mavlinkForwardingChecked.checked
                            anchors.verticalCenter: parent.verticalCenter
                        }
                    }
                    ...
                    Row {
                        ...
                        QGCLabel {
                            width:              _labelWidth
                            anchors.baseline:   mavlinkRaspherriForwardingHostNameField.baseline
                            visible:            QGroundControl.settingsManager.appSettings.forwardRaspherriMavlinkHostName.visible
                            text:               qsTr("Raspberry host name:")
                        }
                        FactTextField {
                            id:                     mavlinkRaspherriForwardingHostNameField
                            fact:                   QGroundControl.settingsManager.appSettings.forwardRaspherriMavlinkHostName
                            width:                  _valueWidth
                            visible:                QGroundControl.settingsManager.appSettings.forwardRaspherriMavlinkHostName.visible
                            enabled:                mavlinkForwardingChecked.checked
                            anchors.verticalCenter: parent.verticalCenter
